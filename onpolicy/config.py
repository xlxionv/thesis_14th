...
def get_config():
    ...
    parser.add_argument("--data_chunk_length", type=int, default=9,
    ...
    # NEW: Expert Data for Behavioral Cloning
    parser.add_argument("--expert_data_path", type=str, default="rh2_expert_data.json", help="Path to the RH2 expert data for Behavioral Cloning.")
